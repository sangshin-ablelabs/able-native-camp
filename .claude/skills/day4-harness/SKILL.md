---
name: day4-harness
description: ABLE Native Camp Day 4. 스킬을 엮어 워크플로우를 만든다. "Day 4", "harness", "워크플로우" 요청에 사용.
---

# Day 4: Harness — 스킬을 엮어 워크플로우를 만든다
...
| 블록 | 파일 | 주제 |
|------|------|------|
| Block 0 | `references/block0-what-is-harness.md` | 하네스란 무엇인가 |
| Block 1 | `references/block1-ceo-workflow.md` | CEO 워크플로우 데모 |
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Level 4: "스킬을 엮어 시스템을 만들 수 있다"
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

오늘 배우는 것:
1. 하네스 = 스킬을 엮어 워크플로우로 만드는 것
2. CEO의 데일리 브리핑 워크플로우 분석
3. 내 업무 흐름 설계
...
AskUserQuestion({
  "questions": [{
    ...
    "options": [
      ...
      {"label": "Block 1: CEO 워크플로우", "description": "데일리 브리핑 워크플로우 분석"},
