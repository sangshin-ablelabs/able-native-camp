---
name: day5-delegate
description: ABLE Native Camp Day 5. 에이전트에게 업무를 통째로 위임한다. "Day 5", "delegate", "위임", "에이전트" 요청에 사용.
---
...
| Block 1 | `references/block1-agent-demo.md` | CEO 에이전트 위임 데모 |
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Level 5: "AI에게 판단까지 맡길 수 있다"
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

오늘 배우는 것:
1. 스킬 vs 하네스 vs 에이전트의 차이
2. 에이전트 = 목표만 주면 방법은 AI가 정한다
3. 위임 가능한 업무 식별법
4. 에이전트 인스트럭션 작성법

"이거 해줘"에서 "이 목표를 달성해줘"로 넘어가는 날이다.
준비됐으면 "시작"이라고 입력해.
```
...
AskUserQuestion({
  "questions": [{
    ...
    "options": [
      ...
      {"label": "Block 1: CEO 데모", "description": "복잡한 업무를 통째로 위임하는 사례"},
